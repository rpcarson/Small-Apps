...
//4
// fetch all categfories ( set  local arry to returned objects)
//per category dfetch notes that have the category
        ...
        if let moc = appDelegate.managedObjectContext {
            ...
            if let catObjects = moc.executeFetchRequest(request, error: nil)  as?  [NSManagedObject] {
                ...
                for catObject in catObjects {
                    ...
                    //                  let predicate = NSPredicate(format: "", arguments:
                    ...
                    // add predicate filter for categroy
