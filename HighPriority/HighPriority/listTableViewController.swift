...
class listTableViewController: UITableViewController {
    ...
    @IBAction func high(sender: UIButton) {
    ...
    @IBAction func medium(sender: UIButton) {
        
        println("orange alert")
        priorityChoice = 1
        
    }
    
    @IBAction func low(sender: UIButton) {
...
//        cell.textLabel?.text = listItems[indexPath.row]["name"] as? String
